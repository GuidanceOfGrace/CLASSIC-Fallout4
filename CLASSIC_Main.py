...
def classic_yaml_generate():  # Other paths will be auto generated by the code.
    if not os.path.exists("CLASSIC Data/CLASSIC FO4 Local.yaml"):
        default_yaml = yaml_get("CLASSIC Data/databases/CLASSIC Main.yaml", "CLASSIC_Info", "default_localyaml")
        with open("CLASSIC Data/CLASSIC FO4 Local.yaml", "w", encoding="utf-8", errors="ignore") as yaml_file:
            yaml_file.write(default_yaml)
...
def docs_path_find():
    ...
    game_sid = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", "Game_Info", "Main_SteamID")
    docs_name = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "Main_Docs_Name")
    ...
    def get_windows_docs_path():
        ...
        yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs", f"{win_docs}")
        ...
        if libraryfolders_path.is_file():
            ...
            for library_line in steam_library:
                ...
                if str(game_sid) in library_line:
                    ...
                    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs", f"{linux_docs}")
    ...
    def get_manual_docs_path():
        ...
        yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs", manual_docs)

    # =========== CHECK IF GAME DOCUMENTS FOLDER PATH WAS GENERATED AND FOUND ===========
    docs_path = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Root_Folder_Docs")
...
def docs_generate_paths():
    ...
    xse_acronym = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "XSE_Acronym")
    docs_path = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Root_Folder_Docs")

    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_Folder_XSE", fr"{docs_path}\{xse_acronym}")
    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_File_PapyrusLog", fr"{docs_path}\Logs\Script\Papyrus.0.log")
    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_File_WryeBashPC", fr"{docs_path}\ModChecker.html")
    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_File_XSE", fr"{docs_path}\{xse_acronym}\{xse_acronym.lower()}.log")
...
def game_path_find():
    ...
    xse_file = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Docs_File_XSE")
    xse_acronym = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "XSE_Acronym")
    root_name = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "Main_Root_Name")
        ...
        with open(xse_file, "r", encoding="utf-8", errors="ignore") as LOG_Check:
            ...
            for logline in Path_Check:
                if "plugin directory" in logline:
                    ...
                    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Game", str(game_path))
    else:
...
def game_generate_paths():
    ...
    game_path = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Root_Folder_Game")
    xse_acronym = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "XSE_Acronym")

    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_Folder_Data", fr"{game_path}Data")
    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_Folder_Scripts", fr"{game_path}Data\Scripts")
    yaml_update("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_Folder_Plugins", fr"{game_path}Data\{xse_acronym}\Plugins")
...
def game_check_integrity() -> str:
    ...
    steam_ini_local = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Game_File_SteamINI")
    exe_hash_old = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "EXE_HashedOLD")
    # exe_hash_new = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "EXE_HashedOLD") | RESERVED FOR 2023 UPDATE
    game_exe_local = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Game_File_EXE")
    root_name = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "Main_Root_Name")
...
def xse_check_integrity() -> str:  # RESERVED | NEED VR HASH/FILE CHECK
    ...
    xse_acronym = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "XSE_Acronym")
    xse_log_file = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Docs_File_XSE")
    xse_full_name = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "XSE_FullName")
    xse_ver_latest = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "XSE_Ver_Latest")
    addlib_file = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Game_File_AddressLib")
...
def xse_check_hashes() -> str:
    ...
    xse_hashedscripts = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "XSE_HashedScripts")
    game_folder_scripts = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Game_Folder_Scripts")
...
def docs_check_ini(ini_name) -> str:
    ...
    folder_docs = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Root_Folder_Docs")
    docs_name = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info", "Main_Docs_Name")
    ...
    if any(ini_name.lower() in file.name.lower() for file in ini_file_list):
        ...
        if ini_name.lower() == f"{docs_name.lower()}custom.ini":
            with open(ini_path, "a", encoding="utf-8", errors="ignore") as ini_file:
                message_list.extend(["❌ WARNING : Archive Invalidation / Loose Files setting is not enabled. \n",
                                     "  CLASSIC will now enable this setting automatically in the game INI files. \n-----\n"])
                customini_config = yaml_get("CLASSIC Data/databases/CLASSIC FO4.yaml", "Default_CustomINI")
...
def main_generate_required():
    ...
    classic_ignorefile()
    vrmode_check()
    folder_game = yaml_get("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info", "Root_Folder_Game")
