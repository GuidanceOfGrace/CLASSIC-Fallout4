...
def game_generate_paths():
    ...
    match game:
        case "Fallout4" if not vr:
            yaml_settings(f"CLASSIC Data/CLASSIC {game} Local.yaml", f"Game{vr}_Info.Game_File_AddressLib", fr"{game_path}Data\{xse_acronym}\version-1-10-163-0.bin")
        case "Fallout4" if vr:
            yaml_settings(f"CLASSIC Data/CLASSIC {game} Local.yaml", f"Game{vr}_Info.Game_File_AddressLib", fr"{game_path}Data\{xse_acronym}\version-1-2-72-0.csv")
