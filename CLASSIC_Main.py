...
def classic_generate_files():  # Other paths will be auto generated by the code.
    ...
    if not os.path.exists("CLASSIC Data/databases/FO4 FID Mods.txt"):
        default_fidfile = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", "Default_FIDMods")
        with open("CLASSIC Data/databases/FO4 FID Mods.txt", "w", encoding="utf-8") as file:
...
def docs_path_find():
    ...
    game_sid = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.Main_SteamID")
    ...
    def get_windows_docs_path():
        ...
        yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs", f"{win_docs}")
        ...
        if libraryfolders_path.is_file():
            ...
            for library_line in steam_library:
                ...
                if str(game_sid) in library_line:
                    ...
                    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs", f"{linux_docs}")
    ...
    def get_manual_docs_path():
        ...
        while True:
            ...
            if os.path.exists(path_input) and os.path.isdir(path_input):
                ...
                yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs", manual_docs)
                break
            else:
    ...
    docs_path = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs")
...
def docs_generate_paths():
    ...
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_Folder_XSE", fr"{docs_path}\{xse_acronym}")
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_File_PapyrusLog", fr"{docs_path}\Logs\Script\Papyrus.0.log")
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_File_WryeBashPC", fr"{docs_path}\ModChecker.html")
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_File_XSE", fr"{docs_path}\{xse_acronym}\{xse_acronym.lower()}.log")
        ...
        with open(xse_file, "r", encoding="utf-8", errors="ignore") as LOG_Check:
            ...
            for logline in Path_Check:
                if "plugin directory" in logline:
                    ...
                    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Game", str(game_path))
    else:
...
def game_generate_paths():
    ...
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_Folder_Data", fr"{game_path}Data")
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_Folder_Scripts", fr"{game_path}Data\Scripts")
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_Folder_Plugins", fr"{game_path}Data\{xse_acronym}\Plugins")
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_File_SteamINI", fr"{game_path}steam_api.ini")
    yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_File_EXE", fr"{game_path}Fallout4{vr}.exe")
...
def game_check_integrity() -> str:
    ...
    steam_ini_local = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_File_SteamINI")
    exe_hash_old = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.EXE_HashedOLD")
    # exe_hash_new = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.EXE_HashedNEW") | RESERVED FOR 2023 UPDATE
    game_exe_local = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_File_EXE")
    root_name = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.Main_Root_Name")
...
def xse_check_integrity() -> str:  # RESERVED | NEED VR HASH/FILE CHECK
    ...
    xse_acronym = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.XSE_Acronym")
    xse_log_file = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Docs_File_XSE")
    xse_full_name = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.XSE_FullName")
    xse_ver_latest = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.XSE_Ver_Latest")
    adlib_file = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_File_AddressLib")

    if Path(adlib_file).exists():
        message_list.append(f"✔️ REQUIRED: *Address Library* for Script Extender is installed! \n-----\n")
    else:
        message_list.append(yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", "Warnings_MODS.Warn_ADLIB_Missing"))
    ...
    if Path(xse_log_file).exists():
        ...
        if str(xse_ver_latest) in xse_data[0]:
            ...
            message_list.append(yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", "Warnings_XSE.Warn_Outdated"))
...
def xse_check_hashes() -> str:
    ...
    xse_hashedscripts = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.XSE_HashedScripts")
    game_folder_scripts = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Game_Folder_Scripts")
    ...
    if xse_script_missing:
        message_list.append(yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", "Warnings_XSE.Warn_Missing"))
    if xse_script_mismatch:
        message_list.append(yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", "Warnings_XSE.Warn_Mismatch"))
...
def docs_check_ini(ini_name) -> str:
    ...
    folder_docs = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Docs")
    docs_name = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", f"Game{vr}_Info.Main_Docs_Name")
    ...
    if any(ini_name.lower() in file.name.lower() for file in ini_file_list):
        ...
        if ini_name.lower() == f"{docs_name.lower()}custom.ini":
            with open(ini_path, "a", encoding="utf-8", errors="ignore") as ini_file:
                message_list.extend(["❌ WARNING : Archive Invalidation / Loose Files setting is not enabled. \n",
                                     "  CLASSIC will now enable this setting automatically in the game INI files. \n-----\n"])
                customini_config = yaml_settings("CLASSIC Data/databases/CLASSIC FO4.yaml", "Default_CustomINI")
...
def main_generate_required():
    ...
    vrmode_check()
    folder_game = yaml_settings("CLASSIC Data/CLASSIC FO4 Local.yaml", f"Game{vr}_Info.Root_Folder_Game")
