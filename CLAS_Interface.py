...
class UiCLASMainWin(object):
    def __init__(self, CLAS_MainWin):
        ...
        self.ChkBT_Stats = create_custom_check_box(CLAS_MainWin, QtCore.QRect(100, 270, 120, 20), "STAT LOGGING", "*DEPRECATED* This checkbox used to enable more detailed statistics but those statistics are not collected anymore.", UNIVERSE.CLAS_config["Stat_Logging"], "ChkBT_Stats", disabled=True)  # Does this do anything anymore?
