...
class ClasCheckMods:
    ...
    Mods1 = {
        ...
        9: {"mod": re.compile(r"Scrap Everything - Ultimate(.*)"),
            "warn": ["SCRAP EVERYTHING (ULTIMATE) \n",
                     "[Weird crashes and issues due to multiple unknown problems. This mod must be always last in your load order.]"]},

        10: {"mod": re.compile(r"Shade Girl Leather Outfits(.*)"),
        ...
        11: {"mod": re.compile("SpringCleaning.esm"),
        ...
        13: {"mod": re.compile("TacticalTablet.esp"),
    ...
    Mods2 = {
        ...
        3: {"mod_1": re.compile("ExtendedWeaponSystem.esm"),
            "mod_2": re.compile("TacticalReload.esm"),
        ...
        6: {"mod_1": re.compile("Fallout4Upscaler.dll"),
        ...
        8: {"mod_1": re.compile("CustomCamera.esp"),
            "mod_2": re.compile("CameraTweaks.esp"),
    ...
    Mods3 = {
        0: {"mod": re.compile("DLCUltraHighResolution.esm"),
        ...
        3: {"mod": re.compile("BTInteriors_Project.esp"),
        ...
        4: {"mod": re.compile("CombatZoneRestored.esp"),
        ...
        5: {"mod": re.compile("D.E.C.A.Y.esp"),
        ...
        6: {"mod": re.compile(r"EveryonesBestFriend(.*)"),
        ...
        7: {"mod": re.compile(r"M8r_Item_Tags(.*)"),
        ...
        8: {"mod": re.compile("Fo4FI_FPS_fix"),
            "warn": ["FO4FI FPS FIX \n",
        ...
        9: {"mod": re.compile("BostonFPSFixAIO.esp"),
            "warn": ["BOSTON FPS FIX \n",
        ...
        10: {"mod": re.compile("FunctionalDisplays.esp"),
        ...
        11: {"mod": re.compile(r"skeletonmaleplayer(.*)"),
        ...
        12: {"mod": re.compile(r"skeletonfemaleplayer(.*)"),
             "warn": ["GENDER SPECIFIC SKELETONS (FEMALE) \n",
                      "- High chance to cause a crash when starting a new game or during the game intro sequence. \n",
                      "  Advised Fix: Enable the mod only after leaving Vault 111. Existing saves shouldn't be affected."]},

        13: {"mod": re.compile("Give Me That Bottle.esp"),
        ...
        14: {"mod": re.compile(r"CapsWidget(.*)"),
             "warn": ["HUD CAPS \n",
        ...
        19: {"mod": re.compile(r"MoreUniques(.*)"),
        ...
        20: {"mod": re.compile(r"NAC.es[pml]"),
        ...
        21: {"mod": re.compile("Northland Diggers New.esp"),
        ...
        22: {"mod": re.compile("Project Zeta.esp"),
             "warn": ["PROJECT ZETA \n",
        ...
        23: {"mod": re.compile("RaiderOverhaul.esp"),
        ...
        24: {"mod": re.compile(r"Rusty Face Fix(.*)"),
             "warn": ["RUSTY FACE FIX \n",
        ...
        26: {"mod": re.compile("StartMeUp.esp"),
             "warn": ["START ME UP \n",
        ...
        27: {"mod": re.compile("SuperMutantRedux.esp"),
        ...
        28: {"mod": re.compile("TacticalReload.esm"),
        ...
        29: {"mod": re.compile("Creatures and Monsters.esp"),
    ...
    Mods4 = {
        0: {"mod": re.compile(r"Beyond the Borders(.*)"),
            "warn": "Beyond the Borders"},
        1: {"mod": re.compile(r"Deadly Commonwealth Expansion(.*)"),
            "warn": "Deadly Commonwealth Expansion"},
        2: {"mod": re.compile(r"Dogmeat and Strong Armor(.*)"),
            "warn": "Dogmeat and Strong Armor"},
        3: {"mod": re.compile(r"DoYourDamnJobCodsworth(.*)"),
            "warn": "Do Your Damn JobCodsworth"},
        4: {"mod": re.compile(r"ConcordEXPANDED(.*)"),
            "warn": "Concord EXPANDED"},
        5: {"mod": re.compile(r"HagenEXPANDED(.*)"),
            "warn": "Hagen EXPANDED"},
        6: {"mod": re.compile(r"GlowingSeaEXPANDED(.*)"),
            "warn": "Glowing Sea EXPANDED"},
        7: {"mod": re.compile(r"SalemEXPANDED(.*)"),
            "warn": "Salem EXPANDED"},
        8: {"mod": re.compile(r"SwampsEXPANDED(.*)"),
            "warn": "Swamps EXPANDED"},
        9: {"mod": re.compile(r"_hod(.*)"),
            "warn": "Halls of the Dead"},
        10: {"mod": re.compile(r"ImmersiveBeantown(.*)"),
             "warn": "Immersive Beantown"},
        11: {"mod": re.compile(r"CovenantComplex(.*)"),
             "warn": "Covenant Complex"},
        12: {"mod": re.compile(r"GunnersPlazaInterior(.*)"),
             "warn": "Gunners Plaza Interior"},
        13: {"mod": re.compile(r"ImmersiveHubCity(.*)"),
             "warn": "Immersive Hub City"},
        14: {"mod": re.compile(r"Immersive_Lexington(.*)"),
             "warn": "Immersive & Extended Lexington"},
        15: {"mod": re.compile(r"Immersive Nahant(.*)"),
             "warn": "Immersive & Extended Nahant"},
        16: {"mod": re.compile(r"Immersive S Boston(.*)"),
             "warn": "Immersive Military Checkpoint"},
        17: {"mod": re.compile(r"MutilatedDeadBodies(.*)"),
             "warn": "Mutilated Dead Bodies"},
        18: {"mod": re.compile("Vault4.esp"),
             "warn": "Fourville (Vault 4)"},
        19: {"mod": re.compile(r"atlanticofficesf23(.*)"),
             "warn": "Lost Building of Atlantic"},
        20: {"mod": re.compile(r"Minutemen Supply Caches(.*)"),
             "warn": "Minutemen Supply Caches"},
        21: {"mod": re.compile(r"moreXplore(.*)"),
             "warn": "More Xplore"},
        22: {"mod": re.compile(r"NEST_BUNKER_PROJECT(.*)"),
             "warn": "NEST Bunker Project"},
        23: {"mod": re.compile("Raider Children.esp"),
             "warn": "Raider Children"},
        24: {"mod": re.compile(r"sectorv(.*)"),
             "warn": "Sector V"},
        25: {"mod": re.compile(r"SettlementShelters(.*)"),
             "warn": "Settlement Shelters"},
        26: {"mod": re.compile(r"subwayrunnerdynamiclighting(.*)"),
             "warn": "Subway Runner (Dynamic Lights)"},
        27: {"mod": re.compile("3DNPC_FO4Settler.esp"),
             "warn": "Settlers of the Commonwealth"},
        28: {"mod": re.compile("3DNPC_FO4.esp"),
             "warn": "Tales from the Commonwealth"},
        29: {"mod": re.compile(r"The Hollow(.*)"),
             "warn": "The Hollow"},
        30: {"mod": re.compile(r"nvvault1080(.*)"),
             "warn": "Vault 1080 (Vault 80)"},
        31: {"mod": re.compile(r"Vertibird Faction Paint Schemes(.*)"),
             "warn": "Vertibird Faction Paint Schemes"},
        32: {"mod": re.compile("MojaveImports.esp"),
             "warn": "Wasteland Imports (Mojave Imports)"},
        33: {"mod": re.compile(r"Firelance2\.5(.*)"),
             "warn": "Xander's Aid"},
        34: {"mod": re.compile(r"zxcMicroAdditions(.*)"),
