...
class ClasCheckMods:
    ...
    Mods1 = [
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?NiTeNull - Shade Girl Leather Outfits(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?SpringCleaning(?:\.esm)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?\(STO\) NO[^.]*(?:\.esp|\.esl|\.esm)?$"),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?TacticalTablet(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?True Nights v03(?:\.esp)?$", regx.MULTILINE),
         "warn": ["TRUE NIGHTS \n",
                  "[Has an invalid Image Space Adapter (IMAD) Record that will corrupt your save memory and has to be manually fixed.]"]},

        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?WeaponsFramework(?:\.esm)?$", regx.MULTILINE),
    ...
    Mods2 = [
        ...
        {"mod_1": regx.compile(r"(?:^\[.*\]\s*)+?FROST(?:\.esp)?$", regx.MULTILINE),
         "mod_2": prp_regex,
        ...
        {"mod_1": regx.compile(r"(?:^\[.*\]\s*)+?DCGuard_Overhaul(?:\.esp)?$", regx.MULTILINE),
         "mod_2": regx.compile(r"(?:^\[.*\]\s*)+?Guards(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod_1": regx.compile(r"(?:^\[.*\]\s*)+?CustomCamera(?:\.esp)?$", regx.MULTILINE),
         "mod_2": regx.compile(r"(?:^\[.*\]\s*)+?CameraTweaks(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod_1": regx.compile(r"(?:^\[.*\]\s*)+?UniquePlayer(?:\.esp)?$", regx.MULTILINE),
         "mod_2": chw_regex,
        ...
        {"mod_1": awkcr_regex,
         "mod_2": regx.compile(r"(?:^\[.*\]\s*)+?SKKCraftableWeaponsAmmo(?:\.esp)?$", regx.MULTILINE),
    ...
    Mods3 = [
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?DLCUltraHighResolution(?:\.esm)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?AAF(?:\.esm)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?BTInteriors_Project(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?CombatZoneRestored(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?D\.E\.C\.A\.Y(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?EveryonesBestFriend(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?M8r_Item_Tags[^.]*(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Fo4FI_FPS_fix(?:\.esp)?$", regx.MULTILINE),
         "warn": ["FO4FI FPS FIX \n",
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?FunctionalDisplays(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?skeleton(male|female)player(?:LMCC)?(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Give Me That Bottle(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?CapsWidget(?:\.esp)?$", regx.MULTILINE),
         "warn": ["HUD CAPS \n",
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?MilitarizedMinutemen(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?MoreUniques(?:\.esp|\.esm|\.esl)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?NAC(?:\.esp|\.esm|\.esl)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Northland Diggers New(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Project Zeta(?:\.esp)?$", regx.MULTILINE),
         "warn": ["PROJECT ZETA \n",
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?RaiderOverhaul(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Rusty Face Fix\.(?:esp|esl)?$", regx.MULTILINE),
         "warn": ["RUSTY FACE FIX \n",
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?SOTS(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?StartMeUp(?:\.esp)?$", regx.MULTILINE),
         "warn": ["START ME UP \n",
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?SuperMutantRedux(?:\.esp)?$", regx.MULTILINE),
        ...
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Creatures and Monsters(?:\.esp)?$", regx.MULTILINE),
    ...
    Mods4 = [
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?BTB- Beyond the Borders FO4(?:\.esp)?$", regx.MULTILINE),
         "warn": "Beyond the Borders"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?The Deadly Commonwealth Expansion(?:\.esp)?$", regx.MULTILINE),
         "warn": "Deadly Commonwealth Expansion"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Dogmeat and Strong Armor - Tumba Munky(?:\.esp)?$", regx.MULTILINE),
         "warn": "Dogmeat and Strong Armor"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?DoYourDamnJobCodsworth(?:\.esp)?$", regx.MULTILINE),
         "warn": "Do Your Damn JobCodsworth"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?ConcordEXPANDED(?:\.esp)?$", regx.MULTILINE),
         "warn": "Concord EXPANDED"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?HagenEXPANDED(?:\.esp)?$", regx.MULTILINE),
         "warn": "Hagen EXPANDED"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?GlowingSeaEXPANDED(?:\.esp)?$", regx.MULTILINE),
         "warn": "Glowing Sea EXPANDED"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?SalemEXPANDED(?:\.esp)?$", regx.MULTILINE),
         "warn": "Salem EXPANDED"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?SwampsEXPANDED(?:\.esp)?$", regx.MULTILINE),
         "warn": "Swamps EXPANDED"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?_hod(?:\.esp)?$", regx.MULTILINE),
         "warn": "Halls of the Dead"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?ImmersiveBeantown(?:\.esp)?$", regx.MULTILINE),
         "warn": "Immersive Beantown"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?CovenantComplex(?:\.esp)?$", regx.MULTILINE),
         "warn": "Covenant Complex"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?GunnersPlazaInterior(?:\.esp)?$", regx.MULTILINE),
         "warn": "Gunners Plaza Interior"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?ImmersiveHubCity(?:\.esp)?$", regx.MULTILINE),
         "warn": "Immersive Hub City"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Immersive_Lexington(?:\.esp)?$", regx.MULTILINE),
         "warn": "Immersive & Extended Lexington"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Immersive Nahant(?:\.esp)?$", regx.MULTILINE),
         "warn": "Immersive & Extended Nahant"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Immersive S Boston(?:\.esp)?$", regx.MULTILINE),
         "warn": "Immersive Military Checkpoint"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?MutilatedDeadBodies(?:\.esp)?$", regx.MULTILINE),
         "warn": "Mutilated Dead Bodies"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Vault4(?:\.esp)?$", regx.MULTILINE),
         "warn": "Fourville (Vault 4)"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?atlanticofficesf23(?:\.esp)?$", regx.MULTILINE),
         "warn": "Lost Building of Atlantic"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Minutemen Supply Caches(?:\.esp)?$", regx.MULTILINE),
         "warn": "Minutemen Supply Caches"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?moreXplore(?:\.esp)?$", regx.MULTILINE),
         "warn": "More Xplore"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?NEST_BUNKER_PROJECT(?:\.esp)?$", regx.MULTILINE),
         "warn": "NEST Bunker Project"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Raider Children(?:\.esp)?$", regx.MULTILINE),
         "warn": "Raider Children"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?sectorv(?:\.esp)?$", regx.MULTILINE),
         "warn": "Sector V"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?SettlementShelters(?:\.esp)?$", regx.MULTILINE),
         "warn": "Settlement Shelters"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?subwayrunnerdynamiclighting(?:\.esp)?$", regx.MULTILINE),
         "warn": "Subway Runner (Dynamic Lights)"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?3DNPC_FO4Settler(?:\.esp)?$", regx.MULTILINE),
         "warn": "Settlers of the Commonwealth"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?3DNPC_FO4(?:\.esp)?$", regx.MULTILINE),
         "warn": "Tales from the Commonwealth"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?The Hollow(?:\.esp)?$", regx.MULTILINE),
         "warn": "The Hollow"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?nvvault1080(?:\.esp)?$", regx.MULTILINE),
         "warn": "Vault 1080 (Vault 80)"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Vertibird Faction Paint Schemes(?:\.esp)?$", regx.MULTILINE),
         "warn": "Vertibird Faction Paint Schemes"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?MojaveImports(?:\.esp)?$", regx.MULTILINE),
         "warn": "Wasteland Imports (Mojave Imports)"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?Firelance2\.5(?:\.esp)?$", regx.MULTILINE),
         "warn": "Xander's Aid"},
        {"mod": regx.compile(r"(?:^\[.*\]\s*)+?zxcMicroAdditions(?:\.esp)?$", regx.MULTILINE),
