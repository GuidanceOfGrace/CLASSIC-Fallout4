...
class ClasCheckMods:
    ...
    chw_regex = re.compile(r"ClassicHolsteredWeapons(.*)", re.IGNORECASE)
    awkcr_regex = re.compile("ArmorKeywords.esm", re.IGNORECASE)
    betterpowerarmor_regex = re.compile("BetterPowerArmorRedux.dll", re.IGNORECASE)
    Mods1 = [
        {"mod": re.compile("DamageThresholdFramework.esm", re.IGNORECASE),
         "warn": ["DAMAGE THRESHOLD FRAMEWORK \n",
                  "[Can cause crashes in combat on some occasions due to how damage calculations are done.]"]},

        {"mod": re.compile("Endless Warfare.esm", re.IGNORECASE),
         "warn": ["ENDLESS WARFARE \n",
                  "[Some enemy spawn points could be bugged or crash the game due to scripts or pathfinding.]"]},

        {"mod": re.compile("EPO.esp", re.IGNORECASE),
        ...
        {"mod": re.compile(r"Scrap Everything - Ultimate(.*)", re.IGNORECASE),
         "warn": ["SCRAP EVERYTHING (ULTIMATE) \n",
                  "[Weird crashes and issues due to multiple unknown problems. This mod must be always last in your load order.]"]},

        {"mod": re.compile(r"Shade Girl Leather Outfits(.*)", re.IGNORECASE),
        ...
        {"mod": re.compile("SpringCleaning.esm", re.IGNORECASE),
        ...
        {"mod": re.compile(r"\(STO\) NO(.*)", re.IGNORECASE),
        ...
        {"mod": re.compile("TacticalTablet.esp", re.IGNORECASE),
        ...
        {"mod": re.compile("WOTC.esp", re.IGNORECASE),
    ...
    Mods2 = [
        {"mod_1": betterpowerarmor_regex,
         "mod_2": re.compile("FloatingDamage.dll", re.IGNORECASE),
        ...
        {"mod_1": betterpowerarmor_regex,
         "mod_2": re.compile("KnockoutFramework.dll", re.IGNORECASE),
         "warn": [" BETTER POWER ARMOR REDUX ❌ CONFLICTS WITH : KNOCKOUT FRAMEWORK \n",
                  "[Both mods use the same script hooks. This can crash the game or cause weird mod behavior.]\n",
                  "[If you encounter problems, You should use only one of these mods, not both at the same time.]"]},

        {"mod_1": re.compile(r"BostonFPSFix(.*)", re.IGNORECASE),
         "mod_2": re.compile("PRP.esp", re.IGNORECASE),
        ...
        {"mod_1": re.compile("ExtendedWeaponSystem.esm", re.IGNORECASE),
         "mod_2": re.compile("TacticalReload.esm", re.IGNORECASE),
        ...
        {"mod_1": re.compile("FROST.esp", re.IGNORECASE),
         "mod_2": re.compile("PRP.esp", re.IGNORECASE),
        ...
        {"mod_1": re.compile("DCGuard_Overhaul.esp", re.IGNORECASE),
         "mod_2": re.compile("Guards.esp", re.IGNORECASE),
        ...
        {"mod_1": re.compile("Fallout4Upscaler.dll", re.IGNORECASE),
         "mod_2": re.compile("NVIDIA_Reflex.dll", re.IGNORECASE),
        ...
        {"mod_1": re.compile(r"vulkan(.*)", re.IGNORECASE),
         "mod_2": re.compile("NVIDIA_Reflex.dll", re.IGNORECASE),
        ...
        {"mod_1": re.compile("CustomCamera.esp", re.IGNORECASE),
         "mod_2": re.compile("CameraTweaks.esp", re.IGNORECASE),
        ...
        {"mod_1": re.compile("UniquePlayer.esp", re.IGNORECASE),
         "mod_2": chw_regex,
        ...
        {"mod_1": re.compile("HHS.dll", re.IGNORECASE),
         "mod_2": chw_regex,
         "warn": ["HIGH HEELS SYSTEM ❌ CONFLICTS WITH : CLASSIC HOLSTERED WEAPONS \n",
                  "[Classic Holstered Weapons will not work correctly with mods that modify the player skeleton or add new skeleton paths.]\n",
                  "[If you encounter problems or crashes, see here how to add additional skeletons: https://www.nexusmods.com/fallout4/articles/2496]"]},

        {"mod_1": re.compile("cbp.dll", re.IGNORECASE),
         "mod_2": chw_regex,
        ...
        {"mod_1": awkcr_regex,
         "mod_2": re.compile("SKKCraftableWeaponsAmmo.esp", re.IGNORECASE),
    ...
    Mods3 = [
        {"mod": re.compile("DLCUltraHighResolution.esm", re.IGNORECASE),
        ...
        {"mod": re.compile("AAF.esm", re.IGNORECASE),
        ...
        {"mod": re.compile("BTInteriors_Project.esp", re.IGNORECASE),
        ...
        {"mod": re.compile("CombatZoneRestored.esp", re.IGNORECASE),
        ...
        {"mod": re.compile("D.E.C.A.Y.esp", re.IGNORECASE),
        ...
        {"mod": re.compile(r"EveryonesBestFriend(.*)", re.IGNORECASE),
        ...
        {"mod": re.compile(r"M8r_Item_Tags(.*)", re.IGNORECASE),
        ...
        {"mod": re.compile("Fo4FI_FPS_fix", re.IGNORECASE),
         "warn": ["FO4FI FPS FIX \n",
        ...
        {"mod": re.compile("BostonFPSFixAIO.esp", re.IGNORECASE),
         "warn": ["BOSTON FPS FIX \n",
        ...
        {"mod": re.compile("FunctionalDisplays.esp", re.IGNORECASE),
        ...
        {"mod": re.compile(r"skeleton(male|female)player(.*)", re.IGNORECASE),
        ...
        {"mod": re.compile("Give Me That Bottle.esp", re.IGNORECASE),
        ...
        {"mod": re.compile(r"CapsWidget(.*)", re.IGNORECASE),
         "warn": ["HUD CAPS \n",
        ...
        {"mod": re.compile(r"MoreUniques(.*)", re.IGNORECASE),
        ...
        {"mod": re.compile("Northland Diggers New.esp", re.IGNORECASE),
        ...
        {"mod": re.compile("Project Zeta.esp", re.IGNORECASE),
         "warn": ["PROJECT ZETA \n",
        ...
        {"mod": re.compile("RaiderOverhaul.esp", re.IGNORECASE),
        ...
        {"mod": re.compile(r"Rusty Face Fix(.*)", re.IGNORECASE),
         "warn": ["RUSTY FACE FIX \n",
        ...
        {"mod": re.compile("SOTS.esp", re.IGNORECASE),
        ...
        {"mod": re.compile("StartMeUp.esp", re.IGNORECASE),
         "warn": ["START ME UP \n",
        ...
        {"mod": re.compile("TacticalReload.esm", re.IGNORECASE),
        ...
        {"mod": re.compile("Creatures and Monsters.esp", re.IGNORECASE),
    ...
    Mods4 = [
        {"mod": re.compile(r"Beyond the Borders(.*)", re.IGNORECASE),
         "warn": "Beyond the Borders"},
        {"mod": re.compile(r"Deadly Commonwealth Expansion(.*)", re.IGNORECASE),
         "warn": "Deadly Commonwealth Expansion"},
        {"mod": re.compile(r"Dogmeat and Strong Armor(.*)", re.IGNORECASE),
         "warn": "Dogmeat and Strong Armor"},
        {"mod": re.compile(r"DoYourDamnJobCodsworth(.*)", re.IGNORECASE),
         "warn": "Do Your Damn JobCodsworth"},
        {"mod": re.compile(r"ConcordEXPANDED(.*)", re.IGNORECASE),
         "warn": "Concord EXPANDED"},
        {"mod": re.compile(r"HagenEXPANDED(.*)", re.IGNORECASE),
         "warn": "Hagen EXPANDED"},
        {"mod": re.compile(r"GlowingSeaEXPANDED(.*)", re.IGNORECASE),
         "warn": "Glowing Sea EXPANDED"},
        {"mod": re.compile(r"SalemEXPANDED(.*)", re.IGNORECASE),
         "warn": "Salem EXPANDED"},
        {"mod": re.compile(r"SwampsEXPANDED(.*)", re.IGNORECASE),
         "warn": "Swamps EXPANDED"},
        {"mod": re.compile(r"_hod(.*)", re.IGNORECASE),
         "warn": "Halls of the Dead"},
        {"mod": re.compile(r"ImmersiveBeantown(.*)", re.IGNORECASE),
         "warn": "Immersive Beantown"},
        {"mod": re.compile(r"CovenantComplex(.*)", re.IGNORECASE),
         "warn": "Covenant Complex"},
        {"mod": re.compile(r"GunnersPlazaInterior(.*)", re.IGNORECASE),
         "warn": "Gunners Plaza Interior"},
        {"mod": re.compile(r"ImmersiveHubCity(.*)", re.IGNORECASE),
         "warn": "Immersive Hub City"},
        {"mod": re.compile(r"Immersive_Lexington(.*)", re.IGNORECASE),
         "warn": "Immersive & Extended Lexington"},
        {"mod": re.compile(r"Immersive Nahant(.*)", re.IGNORECASE),
         "warn": "Immersive & Extended Nahant"},
        {"mod": re.compile(r"Immersive S Boston(.*)", re.IGNORECASE),
         "warn": "Immersive Military Checkpoint"},
        {"mod": re.compile(r"MutilatedDeadBodies(.*)", re.IGNORECASE),
         "warn": "Mutilated Dead Bodies"},
        {"mod": re.compile("Vault4.esp", re.IGNORECASE),
         "warn": "Fourville (Vault 4)"},
        {"mod": re.compile(r"atlanticofficesf23(.*)", re.IGNORECASE),
         "warn": "Lost Building of Atlantic"},
        {"mod": re.compile(r"Minutemen Supply Caches(.*)", re.IGNORECASE),
         "warn": "Minutemen Supply Caches"},
        {"mod": re.compile(r"moreXplore(.*)", re.IGNORECASE),
         "warn": "More Xplore"},
        {"mod": re.compile(r"NEST_BUNKER_PROJECT(.*)", re.IGNORECASE),
         "warn": "NEST Bunker Project"},
        {"mod": re.compile("Raider Children.esp", re.IGNORECASE),
         "warn": "Raider Children"},
        {"mod": re.compile(r"sectorv(.*)", re.IGNORECASE),
         "warn": "Sector V"},
        {"mod": re.compile(r"SettlementShelters(.*)", re.IGNORECASE),
         "warn": "Settlement Shelters"},
        {"mod": re.compile(r"subwayrunnerdynamiclighting(.*)", re.IGNORECASE),
         "warn": "Subway Runner (Dynamic Lights)"},
        {"mod": re.compile("3DNPC_FO4Settler.esp", re.IGNORECASE),
         "warn": "Settlers of the Commonwealth"},
        {"mod": re.compile("3DNPC_FO4.esp", re.IGNORECASE),
         "warn": "Tales from the Commonwealth"},
        {"mod": re.compile(r"The Hollow(.*)", re.IGNORECASE),
         "warn": "The Hollow"},
        {"mod": re.compile(r"nvvault1080(.*)", re.IGNORECASE),
         "warn": "Vault 1080 (Vault 80)"},
        {"mod": re.compile(r"Vertibird Faction Paint Schemes(.*)", re.IGNORECASE),
         "warn": "Vertibird Faction Paint Schemes"},
        {"mod": re.compile("MojaveImports.esp", re.IGNORECASE),
         "warn": "Wasteland Imports (Mojave Imports)"},
        {"mod": re.compile(r"Firelance2\.5(.*)", re.IGNORECASE),
         "warn": "Xander's Aid"},
        {"mod": re.compile(r"zxcMicroAdditions(.*)", re.IGNORECASE),
